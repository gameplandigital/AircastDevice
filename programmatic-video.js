  ...
  request(
    {
      ...
      url:
        ...
        "/programmatic_campaign_config/video/" +
        aircast.config.RpiID +
        "/" +
        CampaignID
    },
      ...
      if (configData.isActive == 1) {
        var programmaticData = {
          ...
          imp: [
            {
              video: {
                w: configData.VideoWidth,
                h: configData.VideoHeight,
                minduration: configData.VideoMinDuration,
                maxduration: configData.VideoMaxDuration,
                boxingallowed: configData.VideoBoxingAllowed,
                ext: {
                  skip: configData.VideoSkip,
                  skipdelay: configData.VideoSkipDelay,
                  rp: {
