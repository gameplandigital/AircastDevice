function temp32Controller($scope, $window, $timeout, $http, tempSrc, callback,$q){ 
    ...
    for(var i=0; i< $scope.TemplateData.length; i++){
		if($scope.TemplateData[i].Template == 'temp32' && $scope.TemplateData[i].CampaignID == tempSrc.CampaignID){
       ...
       function updateValues() {
    	...
    	function loop(){
	        ...
	        if (fb_post.loop) {
                ...
                interval45 = setInterval(function () {
                  fbpostRemoveClass();
                }, fb_post.loopInterval/2);
            
	              interval46 = setInterval(function () {
